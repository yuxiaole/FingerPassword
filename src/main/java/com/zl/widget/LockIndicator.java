...
public class LockIndicator extends View {
	...
	public LockIndicator(Context paramContext, AttributeSet paramAttributeSet) {
		...
		patternNoraml = getResources().getDrawable(R.drawable.gesture_lock_pattern_node_normal);
		patternPressed = getResources().getDrawable(R.drawable.gesture_lock_pattern_node_pressed);
